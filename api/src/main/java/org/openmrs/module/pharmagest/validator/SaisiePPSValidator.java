...
@Service
public class SaisiePPSValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (formulaire.getTabSaisiesPPS().getLigneCommandeSitesCollection() == null) {
		...
		} else if (formulaire.getTabSaisiesPPS().getLigneCommandeSitesCollection() != null) {
			if (formulaire.getTabSaisiesPPS().getLigneCommandeSitesCollection().isEmpty()) {
