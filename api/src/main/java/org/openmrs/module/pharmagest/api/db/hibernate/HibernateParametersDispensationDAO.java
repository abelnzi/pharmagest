...
public class HibernateParametersDispensationDAO implements ParametersDispensationDao {
	...
	// @SuppressWarnings("unchecked")
	// @Override
	// public Collection<Produit> getProduitsByProgramme(PharmProgramme
	// programme) {
	//
	// return (Collection<Produit>)
	// getSessionFactory().getCurrentSession().createCriteria(Produit.class,"prod")
	// .createAlias("PharmRegrouper", "r")
	// .add(Restrictions.eq("r", "prod.prodId"))
	// .add(Restrictions.eq("r.pharmProgramme", programme))
	// .list();
	// }
