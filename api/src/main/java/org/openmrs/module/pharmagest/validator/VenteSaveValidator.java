...
@Service
public class VenteSaveValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if(formulaire.getTabDispensationMvt().getLigneDispensationsCollection()==null){
			...
			}else if(formulaire.getTabDispensationMvt().getLigneDispensationsCollection()!=null){
				if(formulaire.getTabDispensationMvt().getLigneDispensationsCollection().isEmpty()){
				if (pharmProduit == null)
					errors.rejectValue("formulaireOrdonnance.pharmProduit", "choisir le produit");
