...
import org.openmrs.module.pharmagest.validator.StockEntreeValidatorAjout;
...
@RequestMapping(value = "/module/pharmagest/stockEntree.form")
public class StockMvmEntreeController {
	@Autowired
	StockEntreeValidator stockValidator;
	@Autowired
	StockEntreeValidatorAjout stockValidatorAjout;
	@Autowired
	...
	public String initStockFour(ModelMap model) {
		...
		return "/module/pharmagest/stockEntree";
	}
	...
	public void addLigneDispensation(
		...
		try {
			...
			if (!result.hasErrors()) {
				...
				lngOperation.setLgnRecptLot(formulaireStockFourni.getLgnRecptLot().replaceAll(" ", ""));
