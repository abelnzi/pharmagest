...
<openmrs:require privilege="pharmacie reception saisie" 
        otherwise="/login.htm" redirect="/module/pharmagest/saisieReception.form" />
...
<div>
  ...
  <tbody>
    <tr>
      ...
      <td width="2%">&nbsp;</td>
      <td width="15%">Programme <span style="color:#F11A0C">*</span></td>
      <td width="18%">
      ...
      <td width="2%">&nbsp;</td>
      <td width="12%">Type de saisie</td>
      <td width="9%"><form:radiobutton path="typeReception" value="Detail"/>Unité de dispensation</td>
      <td width="12%">
           ...
           <tbody>
                ...
                <tr style="border:0px">
                 ...
                 <form:input path="lgnRecptQteDetailLivree" cssStyle="width:100px"/></div>
                  ...
                  <td colspan="2">&nbsp;
                  <div align="center">Prix unitaire bordereau<br />
                ...
                <tr>
                  ...
                  <td width="12%">Prix unitaire bordereau</td>
...
<div name="divGros" id="divGros">
  ...
  <tbody>
    <tr style="border:0px">
      <td colspan="3"><form:select path="produit" cssStyle="width:300px">
        <option value="0">-- Choix --</option>
        <c:forEach var="item" items="${produits}">
          <option <c:if test="${formulaireReception.getProduit().getProdId()==item.getPharmProduit().getProdId()}">selected="selected"</c:if>    				  										                                value="${item.getPharmProduit().getProdId()}">${item.getFullGrosName()} </option>
        </c:forEach>
      ...
      <td colspan="2">&nbsp;
        <div align="center">Quantit&eacute; livr&eacute;e <span style="color:#F11A0C"> *</span><br />
          <form:input path="lgnRecptQteLivree" cssStyle="width:100px"/>
      </div></td>
      <td colspan="2">&nbsp;
        <div align="center">Quantit&eacute; re&ccedil;ue<span style="color:#F11A0C"> *</span><br />
      ...
      <td>&nbsp;
        <div align="center">Observation<br />
          <form:textarea path="lgnRecptObserv" rows="4" cols="20" />
        </div></td>
      <td>&nbsp;
         <input type="submit" name="btn_valider_gros"
												id="btn_valider_gros" value="Ajouter" onClick=" setChoix(this)"></td>
    </tr>
    <tr>
      <td width="12%">Code article</td>
      <td width="20%">D&eacute;signation</td>
    ...
    <c:forEach var="lo" items="${ligneReceptions}">
      <tr>
        ...
        <td width="10%"><div align="left">${lo.lgnRecptQteLivree}</div></td>
        <td width="10%"><div align="left">${lo.lgnRecptQteDetailLivree}</div></td>
        <td width="10%"><div align="left">${lo.lgnRecptQte}</div></td>
        <td width="10%"><div align="left">${lo.lgnRecptQteDetailRecu}</div></td>
        ...
        <td width="14%"><a
          ...
          " name="btn_valider_gros" onClick=" setChoix(this)">Modifier</a>| <a
										href="<c:url value="/module/pharmagest/saisieReception.form">
            <c:param name="paramId" value="${lo.produit.prodId}${lo.lgnRecptLot}"/>        
            </c:url>
            " name="btn_valider_gros" onClick="setChoix(this)">Supprimer</a></td>
      </tr>
      </c:forEach>
      <tr>
