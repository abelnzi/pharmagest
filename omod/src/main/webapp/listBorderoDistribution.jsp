...
<ul id="menu">
            ...
            <li>
				<a href="<c:url value="/module/pharmagest/listHistoDistribution.form"/>">Historique des distributions effectu&eacute;es par site</a>
			</li>
            <li  class="active">
...
<form:form method="post"
	action="${pageContext.request.contextPath}/module/pharmagest/listBorderoDistribution.form"
...
<c:if test="${var =='2'}">
		<div id="openmrs_msg">Aucun rapport trouv&eacute; </div>
</c:if>
...
<table width="99%" border="1"  cellpadding="7" cellspacing="0">
           <tbody>
                <tr>
                  ...
                  <td width="13%"><strong>Statut</strong></td>
                ...
                <c:forEach var="lo" items="${commandeSites}">
								<tr>
                                    ...
                                    <c:set var="flag" value="${lo.comSiteFlag}" scope="request" />
									 ...
									 %>
									<td width="13%"><strong style="color:#F7072C">
                                    <%= statut %>
                                    </strong></td>
									<td width="21%"><a href="<c:url value="/module/pharmagest/bordereauDistribution.form"><c:param name="paramId" 
