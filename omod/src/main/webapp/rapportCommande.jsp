...
<form:form method="post"
	action="${pageContext.request.contextPath}/module/pharmagest/rapportCommande.form"
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="7">
        <tbody>
          <tr>
            ...
            <td width="2%">:</td>
            <td width="18%"><openmrs_tag:dateField formFieldName="dateCommande" startValue="${formulaireRapportCommande.getDateCommande()}" /></td>
            <td width="43%"><input name="btn_rechercher" type="submit"
...
<table width="100%" border="0" align="" cellpadding="7" cellspacing="7">
  <tbody>
    <tr>
      ...
      <td width="26">&nbsp;</td>
      <td width="26">&nbsp;</td>
      <td width="108" align="right"><input name="btn_valder" type="submit" <%= pageContext.getAttribute("button") %>
