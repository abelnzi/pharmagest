...
<form:form method="post"
	action="${pageContext.request.contextPath}/module/pharmagest/listInventaireModif.form"
	modelAttribute="formulaireInventaire"
	commandName="formulaireInventaire"  >
<div>
<h3 ><span style="font-size:36px">.</span> Choix de l'inventaire &agrave; modifier</h3>
</div>
<br>
...
<div>
  ...
  <tbody>
    <tr>
      ...
      <td width="8%"> <!--<form:input path="dateParam" />--><openmrs_tag:dateField formFieldName="dateParam" startValue="${obsDate}" />
</td>
      <td width="1%">&nbsp;</td>
...
<table width="99%" border="1"  cellpadding="7" cellspacing="0">
           <tbody>
                ...
                <c:forEach var="lo" items="${inventaires}">
								<tr>
                                	<td width="10%">${lo.pharmProgramme.programLib}</td>
									...
									<td width="21%"><a href="<c:url value="/module/pharmagest/inventaireModif.form"><c:param name="paramId" 
                                                  value="${lo.invId}"/></c:url>">Choix</a>
                                                  
                                                  <a href="<c:url value="/module/pharmagest/inventaireSupprim.form"><c:param name="paramId" 
                                                  value="${lo.invId}"/></c:url>">Supprimer</a>
                                    </td>
								</tr>
