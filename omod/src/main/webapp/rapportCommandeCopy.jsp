...
<ul id="menu">
   ...
   <li>
    ...
    <li>
		<a href="<c:url value="/module/pharmagest/rapportConsoProdJour.form"/>">Consommation par Produit par jour</a>
	</li>
		 ...
		 %>
          <tr style="<%= attri %>">
            ...
            <td width="10%"><input type="number" name="cmm<%= x %>" id="cmm<%= x %>" 
                                    				value="${lo.cmm}"></td>
            <td width="8%"><input type="number" name="moisStock<%= x %>" id="moisStock<%= x %>" 
