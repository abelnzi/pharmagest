...
<form:form method="post"
	action="${pageContext.request.contextPath}/module/pharmagest/listHistoDistribution.form"
           ...
           <tbody>
                ...
                <c:forEach var="lo" items="${commandeSites}">
								<tr>
									...
									<td width="21%"><a href="<c:url value="/module/pharmagest/histoDistribution.form"><c:param name="paramId" 
