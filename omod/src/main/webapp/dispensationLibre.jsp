				...
				<tbody>
					<tr>
						<td><input type="submit" name="btn_enregistrer"
							id="btn_enregistrer" value="Enregistrer" onClick="javascript:attribut();"> <input
						...
						<tbody>
							<tr>
								...
								<td width="73%" rowspan="2"><table width="100%" cellpadding="7"
										...
										<tbody>
											<tr>
												<td width="17%" rowspan="2">Régime actuel</td>
												...
												<td width="24%" rowspan="2"><form:label
														path="ordNbreJrsTrai">Nombre de jours de traitement</form:label></td>
					...
					<tbody>
						...
						<c:forEach var="ld" items="${ligneDispensations}">
							<tr>
								...
								<td><a
									href="<c:url value="/module/pharmagest/dispensationLibre.form"><c:param name="paramId" value="${ld.pharmProduit.prodId}${ld.lgnRecptLot}"/></c:url>">X</a>
